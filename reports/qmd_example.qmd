...
![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-horse-pop-plot-largest-sd width=70%}

In @fig-horse-pop-plot-largest-sd we zoom in and look at the province of `{r} province`, which had the largest spread of values in terms of standard deviation.
